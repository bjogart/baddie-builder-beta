...
const ENTRY_TEXT_DF = `<div class="entry vsp vspb"><div class="disp" onclick="toggleEntry(this)"></div><input class="edit hide" type="text" onblur="toggleEntry(this)" value="Slam. [hit]; [dmg] bludgeoning."></div>`;
