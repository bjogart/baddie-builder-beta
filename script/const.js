...
const ENTRY_TEXT_DF = '<div class="entry medbr act"><div class="disp" onclick="toggleEntry(this)"></div><textarea class="edit hide" onblur="toggleEntry(this)" autocomplete="off">[uses: 1] Slam. [hit]; [dmg] bludgeoning.</textarea></div>';
